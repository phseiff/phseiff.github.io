...
<title>javascript-minifier.com | 520: Web server is returning an unknown error</title>
<meta charset="UTF-8" />
...
<div id="cf-wrapper">
    ...
    <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
            ...
            <span class="inline-block sm:block font-mono text-15 lg:text-sm lg:leading-relaxed">Ray ID: 71b7aec41b978214 &bull;</span>
            <span class="inline-block sm:block font-mono text-15 lg:text-sm lg:leading-relaxed">2022-06-15 01:55:17 UTC</span>
...
<div id="cf-host-status" class="cf-error-source relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
  ...
  <span class="md:block w-full truncate">javascript-minifier.com</span>
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">71b7aec41b978214</strong></span>
    <span class="cf-footer-separator sm:hidden">&bull;</span>
    <span class="cf-footer-item sm:block sm:mb-1"><span>Your IP</span>: 20.122.5.107</span>
    <span class="cf-footer-separator sm:hidden">&bull;</span>
